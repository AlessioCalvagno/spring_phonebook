...
public abstract class AbstractDAO<Model extends EntityWrapper> implements DAO<Model> {
...
public AbstractDAO(String FILENAME) {
    ...
    //It gets the Class of parameter at runtime when it instantiates a concrete DAO
